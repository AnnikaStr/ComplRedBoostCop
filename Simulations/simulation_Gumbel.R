################################################################
################################################################
# ---- Simulation Gumbel ---- linear setting, 10 inf. var ---- #
...
dat <- function(data,job){
  ...
  for(i in 1:(n_train + n_eval)){
    data_run <- data.gen(FAM = "gumbel", Z = X_train, i = i)
  ...
  for(i in 1:n_test){
    data_run <- data.gen(FAM = "gumbel", Z = X_test, i = i)
...
classic <- function(job,data,instance){
  ...
  time = Sys.time()
  mod = glmboostLSS(form, data = train, control = boost_control(mstop = 5000, nu = 0.01, risk = "oobag",trace=T), weights = weights_train, method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",
                                                                                                                                                                                       marg2 = "NO"))
  ...
  mod = glmboostLSS(form, data = train, control = boost_control(mstop = MSTOP, nu = 0.01), method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",marg2 = "NO"))
  ...
  loss <- function (y, mu1, sigma1, mu2, sigma2, rho){
    -(log(dnorm(x = y[, 1], mean = mu1, sd = sigma1)) + log(dnorm(x = y[,  
                                                                        2], mean = mu2, sd = sigma2)) + log(exp(rho) + 1) - (1 + exp(rho)) *  
        (log(pnorm(q = y[, 1], mean = mu1, sd = sigma1)) + log(pnorm(q = y[,  
                                                                           2], mean = mu2, sd = sigma2))) - (2 + 1/exp(rho)) * log(pnorm(q = y[,  
                                                                                                                                               1], mean = mu1, sd = sigma1)^(-exp(rho)) + pnorm(q = y[, 2],  
                                                                                                                                                                                                mean = mu2, sd = sigma2)^(-exp(rho)) - 1)) 
  }
...
probing <- function(job, data, instance){
  ...
  time = Sys.time()
  mod = glmboostLSS(form, data = probes.train, control = boost_control(mstop = 2000, nu=0.01),
                    method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",
                                                                marg2 = "NO"))
...
stability <- function(job, data, instance,q){
  ...
  mod = glmboostLSS(form, data = train1,
                    control = boost_control(mstop = 5*nrow(train), nu = 0.01),method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",
                                                                                                                          marg2 = "NO"))
  ...
  for(i in 1:length(pfer)){
    ...
    mod = glmboostLSS(form, data = train,
                      control = boost_control(mstop = 5000, nu = 0.01,risk = 'oobag'), weights = weights_train, method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",
                                                                                                                                                            marg2 = "NO"))
    ...
    mod = glmboostLSS(form, data = train1, control = boost_control(mstop = MSTOP, nu = 0.01), method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",marg2 = "NO"))
...
deselection_change <- function(job, data, instance, tau_1){
  ...
  time = Sys.time()
  mod = glmboostLSS(form, data = train, control = boost_control(mstop = 5000, nu = 0.01, risk = "oobag"), weights = weights_train, method = 'noncyclic', families = Gumbel_Cop(marg1 = "NO",
                                                                                                                                                                               marg2 = "NO"))
  MSTOP <- which.min(risk(mod,merge = T))
  ...
  time = Sys.time()
  mod_desel <- DeselectBoostLSS_5(mod, tau = tau_1, fam = Gumbel_Cop(marg1 = "NO",
                                                                     marg2 = "NO"))
