################################################################
################################################################
# ---------- Application genotype data Chol and LDL ---------- #
...
sim <- function(seed){
  ...
  mod = glmboostLSS(cbind(cholesterol,LDL_adj)~., data = train, control = boost_control(mstop = 10000, nu = 0.01, risk = "oobag", trace = T), weights = weights_train, method = 'noncyclic', families =  Gumbel_Cop(marg1 = "LOGLOG", marg2 = "LOGLOG",stabilization = "MAD"))
  ...
  mod = glmboostLSS(cbind(cholesterol,LDL_adj)~., data = train, control = boost_control(mstop = MSTOP, nu = 0.01, trace = T), method = 'noncyclic', families = Gumbel_Cop(marg1 = "LOGLOG", marg2 = "LOGLOG",stabilization = 'MAD'))
  ...
  save(res, file = paste0("sims_LDL_cholesterol_stabalizationMAD_classic",seed,".RData"))
  ...
  mod_desel <- DeselectBoostLSS_5(mod, tau = tau_1, 
                                  fam = Gumbel_Cop(marg1 = "LOGLOG", marg2 = "LOGLOG",stabilization = 'MAD'))
  ...
  LogLik_desel <- sum(loss(y = test[,c('cholesterol_adj','LDL_adj')], mu1 = pred_mu1_desel, mu2 = pred_mu2_desel,
  ...
  save(res, file = paste0("sims_ldl_chol_desel_",seed,".RData"))
...
save(results, file="Chol_LDL_models.RData")
